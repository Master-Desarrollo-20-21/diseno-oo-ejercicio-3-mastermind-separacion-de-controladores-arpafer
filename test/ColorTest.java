...
public class ColorTest {
    ...
    @Test
    public void testGivenNewColorWhenGetCharacterThenReturn() {
        assertThat(Color.get('X'), is(Color.X));
        assertThat(Color.get('O'), is(Color.O));
    }

    @Test
    public void testGivenColorInvalidWhenGetCharacterThenReturnNull() {

        assertThat(Color.get('A'), is(Color.NULL));
    }
