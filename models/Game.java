...
public class Game {
    ...
    public void setProposedCombination(String combination) {
        assert(this.countAttempt >= 0 && combination != null);                
    ...
    public boolean validColors(String combination) {
        ProposedCombination proposedCombination = new ProposedCombination();
        proposedCombination.set(combination);
        return proposedCombination.validColors();
    }
}
